...
# ga = GeneticAlgorithm(100, 10, 0.7, 0.1, 0.8, num_slots=60, num_locomotions=NUM_LOCOMOTIONS, locomotion_capacity=LOCOMOTION_CAPACITY, time_matrix=time_matrix, passengers_demand=demands*1, peak_repartition=peak_repartition)
sa = SimulatedAnnealing(10000, 0.1, 50, 1000, 60, time_matrix, demands*1, peak_repartition, NUM_LOCOMOTIONS, LOCOMOTION_CAPACITY)
