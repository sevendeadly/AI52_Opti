...
from src.utils.constants import LOCOMOTION_CAPACITY, SERVICE_START, SERVICE_END, NUM_PROGS, PEAK_REPARTITION, DIRECTION_REPARTITION
...
class AntColonyOptimization:
    def __init__(
        ...
        print("Visibility trails initialized")
    ...
    def update_pheromone_trails(self, ant_plans: list[list[Prog]]):
        ...
        for ant_plan in ant_plans:
            for i in range(len(ant_plan)):
                ...
                visibility = self.visibility_trails[direction][position]
                self.pheromone_trails[direction][position] += visibility
    ...
    def optimize(self) -> list[Prog]:
        ...
        for i in range(self.num_iterations):
            ...
            for _ in range(self.num_ants):
                ...
                while not is_valid_plan(ant_plan, LOCOMOTION_CAPACITY) or ant_plan.__len__() != NUM_PROGS:
                    ant_plan: list[Prog] = []
